...
public class Customer_Registration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registration Users");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {  
            ...
            stmt=con.createStatement();
                ResultSet rs = stmt.executeQuery("Select Count(Email) From Customer Where Email = '"+Email+"';");
                  while(rs.next())
                  {
             ...
             Logger.getLogger(Customer_Registration.class.getName()).log(Level.SEVERE, null, ex);
              ...
              else
              {
                           ...
                           //Sql Query
                            String Query="INSERT INTO customer VALUES('"+ID+"','"+Name+"','"+Gender+"','"+Age+"','"+Email+"','"+Password+"','"+CPassword+"')";
